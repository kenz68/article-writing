...
sp_auto_order_medicide_sync_by_scheduler2: procedure
    + arguments
        @Sale_Org_Center: in varchar(50) default '005000SW'
sp_auto_order_medicide_sync_by_scheduler33: procedure
    + arguments
        @Sale_Org_Center: in varchar(50) default '005000SW'
sp_auto_order_vaccine_sync_by_scheduler: procedure
    + arguments
        @Sale_Org_Center: in varchar(50) default ''
sp_auto_order_vaccine_sync_by_scheduler2: procedure
    + arguments
...
sp_dropdiagram: procedure [microsoft_database_tools_support:int=1]
    ...
    + arguments
        @diagramname: in sysname
        @owner_id: in int default null
sp_get_action_farm_org: procedure
sp_getAPI: procedure
    + arguments
        @url: in nvarchar(200)
...
sp_sync_medicine: procedure
    + arguments
        @boby: in nvarchar(max)
sp_sync_medicine2: procedure
    + arguments
        @boby: in nvarchar(max)
        @voucher70id: in int default -1
...
sp_syncGetMasterProductStock2: procedure
...
spApproveGoodsReceipt: procedure
    + arguments
        ...
        @Status: in int
        @LastModifierId: in uniqueidentifier
spApproveGoodsReceiptMultiGR: procedure
    + arguments
...
spCreateFarmBottleRevocationsForHAT: procedure
    + arguments
        @Warehouse: in uniqueidentifier
        @CreatorId: in uniqueidentifier
        @WasteDeliveryTransitId: in int default NULL
        @IPAddress: in varchar(50) default NULL
spCreateFarmOrgId: procedure
    + arguments
        @org_code: in varchar(50)
        @org_name_loc: in nvarchar(50)
        @farm: in varchar(50)
        @name_loc: in nvarchar(50)
        @TYPE: in varchar(50)
        @ACTIVE_FLG: in varchar(1)
        @FARM_ORG: in varchar(50)
...
spCreateFarmScanningTestDetailForLotno: procedure
    + arguments
        ...
        @CreatorId: in uniqueidentifier
        @Type: in int default 0
spCreateFarmScanningTestDetailLotnoForHAT: procedure
    + arguments
        @IdHeader: in int
        @Quantity: in decimal(10,2) default 0
        @QRMapping: in varchar(max)
...
spCreateFarmScanningTestDetailsBottleEmptyForWeb: procedure
    + arguments
        ...
        @QRMapping: in varchar(max)
        @CreatorId: in uniqueidentifier
spCreateFarmScanningTestDetailsForHAT: procedure
    + arguments
        @IdHeader: in int
        @QRMapping: in varchar(max)
        @CreatorId: in uniqueidentifier
...
spCreateFineTicketFromScanTest: procedure
    + arguments
        ...
        @CreatorId: in uniqueidentifier default NULL
        @IPAddress: in varchar(50) default NULL
spCreateFineTicketQRMappingForHAT: procedure
    + arguments
        @FineTicketId: in int
        @QRCode: in varchar(max)
        @CreatorId: in uniqueidentifier default NULL
...
spCreateOrderQRMapping: procedure
    + arguments
        ...
        @OrderId: in int
        @CreatorId: in uniqueidentifier default NULL
spCreateOrgCodePrescription: procedure
    + arguments
...
spCreateQRCodeGR_PRO: procedure
    + arguments
        @Type: in int default NULL
        @ProductId: in uniqueidentifier default NULL
        @Quantity: in decimal(18) default 0
...
spCreateQRMappingDNP_ForPoultry: procedure
    + arguments
        ...
        @LocationX: in varchar(50) default NULL
        @LocationY: in varchar(50) default NULL
spCreateQRMappingDNPForHAT: procedure
    + arguments
        @Warehouse: in uniqueidentifier
        @QRCode: in varchar(50) default NULL
        @QRDNP: in varchar(50) default NULL
...
spCreateReturnVoucher81QRMapping: procedure
    + arguments
        ...
        @QRCode: in varchar(50)
        @CreatorId: in uniqueidentifier default NULL
spCreateReturnVoucher81QRMappingForHAT: procedure
    + arguments
        @Voucher81Id: in int
        @QRCode: in varchar(50)
        @CreatorId: in uniqueidentifier
...
spCreateVoucher63COAFromQR: procedure
    + arguments
        ...
        @CreatorId: in uniqueidentifier default NULL
        @IPAddress: in varchar(50) default NULL
spCreateVoucher63COAFromQRv2: procedure
    + arguments
        @Warehouse: in uniqueidentifier
        @QRCode: in varchar(max)
        @CreatorId: in uniqueidentifier default NULL
...
spCreateVoucher66CancelAndCopy: procedure
    + arguments
        ...
        @CreatorId: in uniqueidentifier default NULL
        @IPAddress: in varchar(50) default NULL
spCreateVoucher66FromFineTicket: procedure
    + arguments
        @FineTicketId: in int
        @CreatorId: in uniqueidentifier default NULL
        @IPAddress: in varchar(50) default NULL
...
spCreateVoucher70From65: procedure
    + arguments
        ...
        @CreatorId: in uniqueidentifier default NULL
        @IPAddress: in varchar(50) default NULL
spCreateVoucher70Group: procedure
    + arguments
        @Warehouse: in uniqueidentifier
...
spCreateVoucher71Copy: procedure
    + arguments
        ...
        @CreatorId: in uniqueidentifier default NULL
        @IPAddress: in varchar(50) default NULL
spCreateVoucher71FromHO: procedure
    + arguments
        @Voucher81Id: in int
        @CreatorId: in uniqueidentifier default NULL
        @IPAddress: in varchar(50) default NULL
...
spDeleteCPVoucher63: procedure
    + arguments
        @Voucher63Id: in int
spDeleteCPVoucher63Location: procedure
    + arguments
        @Voucher63Id: in int
spDeleteCPVoucher65Derect: procedure
    + arguments
        @Voucher65Id: in int
...
spDeleteMedicinePrescription: procedure
    + arguments
        @STT: in int
        @LastModifierId: in uniqueidentifier
spDeleteMedicineVoucher65Branch: procedure
    + arguments
        @Voucher65Id: in int
...
spExcelWasteDeliveryTransit: procedure
    + arguments
        @Id: in varchar(max)
spExportExcelScanTestResult: procedure
    + arguments
        @ScheduleId: in varchar(max) default 30
...
spGetAreaByDepartment: procedure
    + arguments
        @DepartmentId: in uniqueidentifier
...
spGetBranchWarehouseBottle: procedure
    + arguments
        ...
        @ToDate: in date default NULL
        @Id: in varchar(max) default NULL
spGetBranchWarehouseBottle_ForFultry: procedure
    + arguments
        @Option: in int
...
spGetCPVoucher63FarmToFarm: procedure
    + arguments
        @Voucher63Id: in int
spGetCPVoucher63FarmToFarmGiaCam: procedure
    + arguments
        @Voucher63Id: in int
...
spGetDeleteMedicineBranchVoucher66Plus: procedure
    + arguments
        @AdjustId: in int
spGetDeleteVoucher66Plus: procedure
    + arguments
        @GRDocNum: in int
...
spGetExcelScanningTestDetails: procedure
    + arguments
        @IdHeader: in varchar(max)
spGetExcelScanningTestResult: procedure
    + arguments
        @IdHeader: in varchar(max)
...
spGetExcelVoucher70Details: procedure
    + arguments
        @Voucher70Id: in varchar(max)
spGetExcelVoucher70QRMapping: procedure
    + arguments
        @Warehouse: in uniqueidentifier
        @FromDate: in date default NULL
        @ToDate: in date default NULL
...
spGetFarmBottleRevocations: procedure
    + arguments
        ...
        @FromDate: in date default NULL
        @ToDate: in date default NULL
spGetFarmBottleRevocationsForHAT: procedure
    + arguments
        @Option: in int default 0
        @Warehouse: in uniqueidentifier
        @BottleRevocationNo: in varchar(50) default NULL
...
spGetFarmOrgByOrderOfFarm: procedure
    + arguments
        @OrderId: in int
        @Option: in int default 1
spGetFarmOrgByWarehouse: procedure
    + arguments
        @Warehouse: in uniqueidentifier
...
spGetFarmQRCodeList_HAT: procedure
    + arguments
        ...
        @Type: in varchar(50) default NULL
        @option: in int default 1
spGetFarmQRCodeList_HATForScan: procedure
    + arguments
        @Warehouse: in uniqueidentifier default 'E10D1418-0649-4132-87D7-B0274B70D87E'
        @QRCode: in varchar(50) default NULL
...
spGetLocationHistoryForMobile: procedure
    + arguments
        @QRCode: in varchar(12)
spGetLocationMapping: procedure
    + arguments
...
spGetMasterCostBF: procedure
    + arguments
        ...
        @ToDate: in date
        @ProductIds: in varchar(max) default NULL
spGetMasterCostBFFromORG_CODE: procedure
    + arguments
        @OrgCode: in varchar(50)
...
spGetMedicineVoucher63GiaCam: procedure
    + arguments
        @Voucher63Id: in int
spGetMedicineVoucher63SW: procedure
    + arguments
        @Voucher63Id: in int
...
spGetOrderQRMappingByDocNum: procedure
    + arguments
        ...
        @ProductName: in nvarchar(200) default NULL
        @LotNumber: in varchar(50) default NULL
spGetOrderQRMappingByDocNum_v2: procedure
    + arguments
        @GIDocNum: in int default NULL
        @OrderId: in int default NULL
...
spGetQRCodeHOExcel: procedure
    + arguments
        ...
        @FromDate: in date default NULL
        @ToDate: in date default NULL
spGetQRCodeHOExcel_BK: procedure
    + arguments
        @Option: in int default 0
        @Warehouse: in uniqueidentifier default NULL
        @QRCode: in varchar(max) default NULL
...
spGetScanningTestDetailsStock: procedure
    + arguments
        ...
        @ProductName: in nvarchar(50) default NULL
        @LotNumber: in varchar(50) default NULL
spGetScanningTestForHAT: procedure
    + arguments
        @Option: in int default 1
        @Warehouse: in uniqueidentifier
        @ScanTestNo: in varchar(50) default NULL
...
spGetScanningTestResult: procedure
    + arguments
        @Option: in int default 1
        @IdHeader: in int
spGetScanningTestResultForHAT: procedure
    + arguments
        @Option: in int default 1
        @IdHeader: in int
...
spGetVoucher84Detail: procedure
    + arguments
        @Voucher84Id: in int
spGetVoucher84DetailsHAT: procedure
    + arguments
        @Voucher84Id: in int
...
spGetVoucherCancelExcel: procedure
    + arguments
        @FineTicketId: in varchar(max) default NULL
spGetVoucherCancelExcelForHAT: procedure
    + arguments
        @FineTicketId: in varchar(max) default NULL
...
spGetVoucherUsedQRMappingForMobile: procedure
    + arguments
        @VoucherUsedId: in int
spGetVoucherUsedReport: procedure
    + arguments
        @Action: in varchar(50)
        @VoucherUsedId: in int
...
spInventoryVoucher66Branch: procedure
    + arguments
        @VoucherId: in int
        @CreatorId: in uniqueidentifier default NULL
spInventoryVoucher66ForHAT: procedure
    + arguments
        @VoucherId: in int
        @CreatorId: in uniqueidentifier default NULL
...
spReport1: procedure
    + arguments
        @Warehouse: in uniqueidentifier default 'AA8C6CF8-C534-45FC-9148-4FFE37E79EF1'
...
spReportWarehouseHAT: procedure
    + arguments
        @FromDate: in datetime
        @ToDate: in datetime
        @Locations: in nvarchar(max) default NULL
...
spUpdateInvoiceForVoucher81Derect: procedure
    + arguments
        @Voucher81Id: in int
spUpdateInvoiceForVoucher81ForHAT: procedure
    + arguments
        @Voucher81Id: in int
...
spUpdatePrinted: procedure
    + arguments
        @QRCode: in varchar(max) default NULL
        @PrintQueueStatus: in int
spUpdatePrintQRCodeQueues: procedure
    + arguments
        @PrintQueueId: in int
        @GRDocNum: in int default 823
        @ProductId: in uniqueidentifier default 'FD6DC1BC-1690-437F-A94D-6E88548C0F8B'
...
spUpdateProduct: procedure
    + arguments
        ...
        @BottleWeight: in decimal(10,1)
        @UnitSpecification: in int default 1
        @Weight: in decimal(10,1)
        @IsQRProduct: in bit
        @IsQRLotno: in bit
...
spUpdateWasteDelivery: procedure
    + arguments
        ...
        @LastModifierId: in uniqueidentifier
        @Note: in nvarchar(200) default NULL
        @TotalWeight: in decimal(10,2) default NULL
